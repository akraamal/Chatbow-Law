...
**Source :** `data\processed\fr\BO_7470_Fr.txt`
**Langue :** fr
...
décret n°2-25-967 du 20 joumada II 1447 (11 décembre 2025)
approuvant la décision de Bank Al-Maghrib relative à la
mise en circulation d'un billet de banque de 100 dirhams
commémorant la 35ème édition de la Coupe d'Afrique des
Nations - Maroc 2025.
...
*Entités :* `7 novembre 2025` (DATE_GREGORIAN), `soixante-dix millions d'euros` (MONEY)

*Organisations :* Banque européenne
d'investissement, Office national de l'électricité et de l'eau
potable
...
*Entités :* `ministre de l'économie et des finances` (MINISTERE), `5 rabii I 1402` (DATE_HIJRI), `1er janvier 1982` (DATE_GREGORIAN), `20 joumada II 1447` (DATE_HIJRI), `11 décembre 2025` (DATE_GREGORIAN)

*Dates :* 5 rabii I 1402, 1er janvier 1982, 20 joumada II 1447, 11 décembre 2025
...
*Entités :* `7 novembre 2025` (DATE_GREGORIAN), `soixante-dix millions d'euros` (MONEY), `Bulletin officiel » n° 7469 du 8 rejeb 1447 (29 décembre 2025)` (BULLETIN_OFFICIEL)
...
*Entités :* `loi n° 84-21 relative à l'aquaculture marine,` (LOI)
...
*Entités :* `arrêté` (ARRETE), `loi n° 84-21 relative à l'aquaculture marine,` (LOI)
...
*Entités :* `loi n° 84-21` (LOI), `loi n° 84-21 relative à l'aquaculture marine,` (LOI), `loi n°52-09` (LOI), `loi n°48-95` (LOI)
...
*Entités :* `arrêté` (ARRETE), `loi n°29-05 relative à la protection des espèces de folre et de faune sauvage` (LOI)
...
*Entités :* `loi n° 84-21` (LOI), `arrêté` (ARRETE), `loi n° 84-21 relative à l'aquaculture marine,` (LOI)
...
*Entités :* `arrêtés` (ARRETE), `loi n° 84-21 relative à l'aquaculture marine,` (LOI)
...
*Entités :* `loi n° 44-12 relative à l'appel public à` (LOI), `loi n° 36-01` (LOI)
...
*Entités :* `décret n°2-09-684` (DECRET), `décret n° 2-09-684` (DECRET)
...
*Entités :* `1er janvier 2026` (DATE_GREGORIAN), `arrêté susvisé n° 771-13` (ARRETE), `18 rabii II 1434` (DATE_HIJRI), `1er mars 2013` (DATE_GREGORIAN), `arrêté` (ARRETE)
...
*Entités :* `société « BRAIKA AQUACULTURE Sarl AU »` (ORG), `6 joumada I 1447` (DATE_HIJRI), `29 octobre 2025` (DATE_GREGORIAN), `ministre de l'agriculture` (MINISTERE), `dahir portant loi n° 1-73-255 du 27 chaoual 1393 (23 novembre 1973)` (DAHIR), `décret n° 2-08-562` (DECRET), `13 hija 1429` (DATE_HIJRI), `12 décembre 2008` (DATE_GREGORIAN)

*Citations :*

- `articles 28 et 28-1` → décret n° 2-08-562 [✓]
- `articles 7, 7` → décret n° 2-08-562 [✓]

*Organisations :* BRAIKA, Braika Aquaculture

*Dates :* 6 joumada I 1447, 29 octobre 2025, 13 hija 1429, 12 décembre 2008
...
*Entités :* `société « BRAIKA AQUACULTURE Sarl AU »` (ORG), `arrêté` (ARRETE), `ministre de l'économie et des finances` (MINISTERE), `28 rabii I 1443` (DATE_HIJRI), `4 novembre 2021` (DATE_GREGORIAN), `dahir portant loi n° 1-73-255 du 27 chaoual 1393 (23 novembre 1973)` (DAHIR), `ministre de l'agriculture` (MINISTERE), `25 rabii II 1446` (DATE_HIJRI), `29 octobre 2024` (DATE_GREGORIAN)
...
*Entités :* `arrêté conjoint` (ARRETE), `25 joumada II 1447` (DATE_HIJRI), `16 décembre 2025` (DATE_GREGORIAN), `arrêté conjoint du ministre de l'économie et des` (ARRETE), `ministre de l'agriculture` (MINISTERE), `7 moharrem 1435` (DATE_HIJRI), `11 novembre 2013` (DATE_GREGORIAN)

*Dates :* 25 joumada II 1447, 16 décembre 2025, 7 moharrem 1435, 11 novembre 2013
...
*Entités :* `ministre de l'économie et des finances` (MINISTERE), `ministre de l'agriculture` (MINISTERE), `25 joumada II 1447` (DATE_HIJRI), `16 décembre 2025` (DATE_GREGORIAN), `société « BRAIKA AQUACULTURE Sarl AU »` (ORG)
...
*Entités :* `arrêté susvisé n° 2797-95` (ARRETE), `20 joumada II 1416` (DATE_HIJRI), `14 novembre 1995` (DATE_GREGORIAN), `loi n° 016-89` (LOI), `31 mai 2022` (DATE_GREGORIAN), `30 juin 2020` (DATE_GREGORIAN), `arrêté n° 2797-95` (ARRETE)
...
*Entités :* `arrêté susvisé n° 2797-95` (ARRETE), `20 joumada II 1416` (DATE_HIJRI), `14 novembre 1995` (DATE_GREGORIAN), `loi n° 016-89` (LOI), `30 juin 2023` (DATE_GREGORIAN), `arrêté n° 2797-95` (ARRETE)
...
*Entités :* `arrêté susvisé n° 2797-95` (ARRETE), `20 joumada II 1416` (DATE_HIJRI), `14 novembre 1995` (DATE_GREGORIAN), `loi n° 016-89` (LOI), `7 juin 2024` (DATE_GREGORIAN), `30 juin 2022` (DATE_GREGORIAN), `arrêté n° 2797-95` (ARRETE)
...
*Entités :* `arrêté susvisé n° 2797-95` (ARRETE), `20 joumada II 1416` (DATE_HIJRI), `14 novembre 1995` (DATE_GREGORIAN), `loi n° 016-89` (LOI), `31 décembre 2022` (DATE_GREGORIAN), `30 juin 2016` (DATE_GREGORIAN), `arrêté n° 2797-95` (ARRETE)
...
*Entités :* `arrêté susvisé n° 2797-95` (ARRETE), `20 joumada II 1416` (DATE_HIJRI), `14 novembre 1995` (DATE_GREGORIAN), `loi n° 016-89` (LOI), `4 juin 2021` (DATE_GREGORIAN), `arrêté n° 2797-95` (ARRETE)
...
*Entités :* `arrêté susvisé n° 2797-95` (ARRETE), `20 joumada II 1416` (DATE_HIJRI), `14 novembre 1995` (DATE_GREGORIAN), `loi n° 016-89` (LOI), `31 mai 2023` (DATE_GREGORIAN), `30 juin 2021` (DATE_GREGORIAN), `arrêté n° 2797-95` (ARRETE)
...
*Entités :* `arrêté susvisé n° 2797-95` (ARRETE), `20 joumada II 1416` (DATE_HIJRI), `14 novembre 1995` (DATE_GREGORIAN), `loi n° 016-89` (LOI), `9 juillet 2024` (DATE_GREGORIAN), `7 juillet 2022` (DATE_GREGORIAN), `arrêté n° 2797-95` (ARRETE)
...
*Entités :* `arrêté susvisé n° 2797-95` (ARRETE), `20 joumada II 1416` (DATE_HIJRI), `14 novembre 1995` (DATE_GREGORIAN), `loi n° 016-89` (LOI), `31 mai 2023` (DATE_GREGORIAN), `21 juillet 2021` (DATE_GREGORIAN), `arrêté n° 2797-95` (ARRETE)
